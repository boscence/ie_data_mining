...
fits2 =  lm(E..coli..MF. ~  PO4.filt...mg.L.as.P.+ Total.P..mg.L.as.P.+ Susp..Solids..mg.L.+Total.N+ Temp...C.+training_data$DO..mg.L.+quality+landuse, data = training_data,scale = T)

fits2.pred = predict(fits2,newdata = training_data)

mean((fits2.pred - training_data$E..coli..MF.)^2, na.rm = T)

summary(fits2)

#Applying the expected transforms

fits3 = lm(scale(E..coli..MF.) ~  New.Site.Code...post.Jun.2007.+ scale(I(exp(PO4.filt...mg.L.as.P.)))+ scale(Total.P..mg.L.as.P.)+ scale(Susp..Solids..mg.L.)+scale(Total.N)+ scale(Temp...C.)+scale(poly(training_data$DO..mg.L.,2))+scale(poly(training_data$DO....sat..,2))+quality+landuse, data = training_data)
